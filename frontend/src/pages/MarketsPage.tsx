          ...
          <table className="w-full text-sm min-w-[640px]">
            <thead>
              <tr className="text-[#848e9c] text-xs border-b border-[#2b3139]">
                ...
                <th className="text-right px-5 py-3 font-medium hidden sm:table-cell">Volume</th>
            ...
            <tbody>
              {filtered.map((m, i) => (
                <tr key={m.symbol} className="border-b border-[#2b3139]/50 hover:bg-[#1e2329] transition cursor-pointer">
                  ...
                  <td className="px-5 py-4 text-right font-mono text-[#eaecef] whitespace-nowrap">${m.price.toLocaleString()}</td>
                  ...
                  <td className="px-5 py-4 text-right text-[#848e9c] text-xs hidden sm:table-cell">{m.vol}</td>
                  <td className="px-5 py-4 text-right text-[#848e9c] text-xs hidden md:table-cell">{m.mcap}</td>
